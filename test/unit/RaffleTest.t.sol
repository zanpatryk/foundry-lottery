...
contract RaffleTest is Test {
    ...
    function testRaffteInitializesInOpenState() public view {
    ...
    function testCheckUpkeepReturnsFalseLackingBalance() public {
        vm.warp(block.timestamp + _interval + 1);
        vm.roll(block.number + 1);
    ...
    function testPerformUpkeepRunWhenCheckUpkeepTrue() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: _entranceFee}();
        vm.warp(block.timestamp + _interval + 1);
        vm.roll(block.number + 1);
    ...
    function testPerformUpkeepUpdatesRaffleStanteAndEmitsRequestId()
        public
        ...
        skipFork
    {
        ...
        assert(
            raffle.getRecentWinner().balance ==
                (prize + STARTING_BALANCE - _entranceFee)
        );
    }
}
